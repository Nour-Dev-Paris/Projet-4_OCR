...
<?php ob_start(); ?>
    ...
    <div class="listPanel">
        <p class="style_report report_ticket">Voulez-vous vraiment supprimer ce commentaire :<br> <?= $getCommentView['comment']; ?> <br> Cette action sera définitive ! </p>
        <a class="button_removePost delete_view" href="index.php?action=deleteComment&amp;id=<?= $getCommentView['id']; ?>">Valider</a>
